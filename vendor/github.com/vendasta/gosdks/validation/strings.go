...
func StringNotEmpty(data string, errorType util.ErrorType, message string) Rule {
...
func StringMaxLength(data string, max int, errorType util.ErrorType, message string) Rule {
...
func AtLeastOneStringRequired(data []string, errorType util.ErrorType, message string) Rule {
...
func OptionalStringValidation(data string, rule Rule) Rule {
	return Optional(data != "", rule)
}
...
func ValidURL(data string, errorType util.ErrorType, message string) Rule {
...
func URLHostEquals(data string, host string, errorType util.ErrorType, message string) Rule {
...
func URLHostEndsWith(data string, host string, errorType util.ErrorType, message string) Rule {
...
func URLHostEqualsOneOf(data string, hosts []string, errorType util.ErrorType, message string) Rule {
...
func URLPathNotEmpty(data string, errorType util.ErrorType, message string) Rule {
...
func (r *validEmail) Validate() error {
	...
	if indexOfDot == len(dataAfterAt)-1 {
		return util.Error(r.errorType, r.message)
	}
	return nil
}
...
func ValidEmail(data string, errorType util.ErrorType, message string) Rule {
...
func URLHostEndsWithOneOf(data string, hosts []string, errorType util.ErrorType, message string) Rule {
...
func StringInSlice(data string, slice []string, errorType util.ErrorType, message string) Rule {
